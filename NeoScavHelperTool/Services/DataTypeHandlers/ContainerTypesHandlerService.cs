...
{
    public class ContainerTypesHandlerService
        : NewModBaseHandlerService<ContainerTypesHandlerService, ContainerTypesItem>
    {
        public const string TABLE = "containertypes";
        ...
        private const string UPSERT_ITEM_SQL =
            @"
            INSERT OR REPLACE INTO `{0}_containertypes` (
              `id`,
              `strName`,
              `isOverriden`,
              `valueModFolder`
