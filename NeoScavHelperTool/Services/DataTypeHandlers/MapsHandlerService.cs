...
{
    public class MapsHandlerService : NewModBaseHandlerService<MapsHandlerService, MapsItem>
    {
        public const string TABLE = "maps";
        ...
        private const string UPSERT_ITEM_SQL =
            @"
            INSERT OR REPLACE INTO `{0}_maps` (
              `id`,
              `strName`,
              `strDef`,
              `isOverriden`,
