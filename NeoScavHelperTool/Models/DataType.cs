...
namespace NeoScavHelperTool.Models
{
    public enum DataType
    {
        ...
        [DataType(
            ...
            Type = ModType.New,
            Table = IngredientsHandlerService.TABLE,
            Handler = typeof(IngredientsHandlerService)
        )]
        Ingredients,
        ...
        [DataType(
            File = "itemprops.xml",
            Type = ModType.New,
            Table = ItemPropsHandlerService.TABLE,
            Handler = typeof(ItemPropsHandlerService)
        )]
        ItemProps,
